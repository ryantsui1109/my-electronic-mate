    ...
    <>
      <Form id="character-info">
        ...
        <Form.Group className="mb-3" controlId="formBasicSelfSetup">
          ...
          <Form.Control type="text" placeholder="輸入桌寵自稱詞" />
        ...
        <Form.Group className="mb-3" controlId="formBasicCall">
          ...
          <Form.Control type="text" placeholder="輸入桌寵對使用者的稱呼" />
        ...
        <Form.Group className="mb-3" controlId="formBasicTags">
          ...
          <InputGroup>
            ...
            <Button
              variant="primary"
              id="button-addon1"
              onClick={handleAddMATag}
            >
              <i className="bi bi-plus-lg" />
            </Button>
          </InputGroup>
          <Form.Text className="text-muted">
            EX:講話時以喵結尾、喜歡用顔文字、經常嘆氣
          </Form.Text>
          <br />
          <Form.Text>
